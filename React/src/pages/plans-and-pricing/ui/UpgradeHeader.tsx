...
export default function UpgradeHeader({ onClose }) {
    return (
        <div className="pt-[15px] pb-[26px] px-[15px] border-b border-white relative">
            <Button variant={"ghost"} type="button" className="absolute top-3 right-3 hover:bg-transparent" icon={<CrossIcon color="white" size="40" />} onClick={() => onClose(undefined)}>
            ...
            <p className="text-[13px] leading-5 Gilroy-normal text-white text-center capitalize max-w-[420px] mx-auto">
                Upgrade now to more credits, brands, and users; achieve <span className="text-primary">better results</span>; and receive <span className="text-primary">faster support</span>
            </p>
        </div>)
}
