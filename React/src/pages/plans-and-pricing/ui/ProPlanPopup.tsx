...
export function ProPlanPopup() {
    return (
        <CustomDiv style="max-w-[581px] mx-auto text-center !rounded-[16px]  mx-auto mt-50">
            <div className="text-right">
                <Link to="/plans-pricing" className='flex justify-end'><CrossIcon color="white" size="2rem" /></Link>
            </div>
            <h2 className="text-[44px] leading-[44px] Gilroy-bold text-primary text-center capitalize mt-2 mb-11">Confirm Pro Plan</h2>
