                ...
                <div className="bg-white py-5 px-5 rounded-xl w-full max-w-2xl relative">
                    ...
                    <div className="mt-3 flex justify-center gap-4">
                        ...
                        <div className="flex flex-col gap-5 justify-between items-center max-w-[431px]">
                            ...
                            <Button variant="outline" onClick={() => setAcceptOffer(true)} className="w-full rounded-full text-base bg-primary-button text-white py-5 " label='Claim 50% Discount'></Button>
