...
export default function CancleSubscriptionPopUp2({ onClose, onAccept }: CancleSubscriptionPropsType) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-xs bg-black/10">
            <div className="bg-white py-5 px-5 rounded-xl w-full max-w-2xl relative">
                <div className="relative">
                    ...
                    <Button
                        variant="ghost"
                        className="absolute -right-3 -top-3 hover:bg-transparent"
                        onClick={handleAcceptOffer}
                        icon={<CrossIcon color="gray" size="3rem" />}
                ...
                <div className="mt-3 text-left">
                    ...
                    <Button
                        variant="outline"
                        onClick={handleAcceptOffer}
                        className="w-full rounded-full text-base bg-primary-button text-white py-6"
                        label="Got it! Return to App"
                    />
                </div>
            </div>
        </div>
